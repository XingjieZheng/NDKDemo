...
Java_com_xingjiezheng_MainActivity_stringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_xingjiezheng_MainActivity_getData(
        JNIEnv *env,
        jobject thiz) {
#if defined(__arm__)
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    jclass clz = env->FindClass("com/xingjiezheng/JniHandler");
...
Java_com_xingjiezheng_MainActivity_startTicks(JNIEnv *env, jobject instance) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_xingjiezheng_MainActivity_stopTicks(JNIEnv *env, jobject instance) {
